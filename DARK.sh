...
install() {
echo -e "\033[0;36m"
echo -e "~ Welcome To Source darkenteam - اهلا بك في سورس دارك ~"
...
echo -e "|   
echo -e "|-------------------------------------------|"
echo -e "|This Source Was Developed By (ABS) @description.|"
echo -e "|  This Is The Source Channel @darkenteam .   |"
echo -e "|               - darkenteam -                 |"
echo -e "---------------------------------------------"
echo -e "\033[0m"
